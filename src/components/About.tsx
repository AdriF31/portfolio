        ...
        <div className="grid gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                I'm a{" "}
                <strong className="text-teal-300">Mobile Developer</strong> with
                3 years of experience building cross-platform applications using
                Flutter. Based in Bandung, I'm passionate about learning new
                technologies and continuously growing my skills to create
